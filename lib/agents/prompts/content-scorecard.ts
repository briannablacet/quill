...
- Avoids banned words as ordinary vocabulary: revolutionize(ing/-tion), transform(ing/-ation), disrupt(ing/-ion), reinvent(ing), evolve/evolving/evolution, unlock(ing), elevate/elevating, accelerate, amplify/amplified, empower(ing/-ment), master/mastering/mastery, unleash(ing), unchain(ing), leverage/leveraging, synergy/synergize, paradigm, innovative, cutting-edge, next-level, game-changing, breakthrough, seamless, scalable, robust, dynamic, strategic, holistic, comprehensive, integrated, streamlined, optimize/optimizing, maximize, thrilled, thrill. Quoting one of these words verbatim inside a real, existing proper noun or job title (e.g. "Director of AI Transformation") is NOT a violation and must not be flagged — only flag a case where the word is used as ordinary descriptive vocabulary outside such a quote.
